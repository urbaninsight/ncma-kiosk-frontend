...
export default function AdditionalControls() {
  ...
  return (
    <div className="mr-[-1px] flex flex-col items-center justify-center gap-y-[0.618rem] rounded-lg p-4 cloverXs:flex-row cloverXs:gap-x-[0.618rem]">
      {museumObjectState.kioskMode && (
        <div className="additional-controls-instruction w-max-content hidden h-8 items-center justify-center rounded-md bg-black px-[18px] py-[15px] text-white cloverXs:flex">
      ...
      >
        ...
        <span className="hidden cloverXs:block">
